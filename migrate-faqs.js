// Simple script to migrate FAQs to Firestore
import { initializeApp } from 'firebase/app';
import { getFirestore, collection, addDoc } from 'firebase/firestore';

// Firebase config
const firebaseConfig = {
    apiKey: "AIzaSyBp_q1LRxKwN9OCFnKoY3WfjPoqZfhnZf4",
    authDomain: "valparapadel.firebaseapp.com",
    projectId: "valparapadel",
    storageBucket: "valparapadel.firebasestorage.app",
    messagingSenderId: "688448816430",
    appId: "1:688448816430:web:6b3c8c2e1bfb6f3a8d5e4f"
};
...
async function migrateFAQs() {
    ...
    try {
        for (const faq of faqData) {
            ...
            console.log(`Added FAQ: ${faq.question.substring(0, 50)}... (ID: ${docRef.id})`);
        }
